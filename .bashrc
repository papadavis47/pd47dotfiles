...
HISTIGNORE="history:pwd:e:c:exit:ls:ls -la:ll"
...
# The following is for making the powerline look on terminal. I can get rid of it later by deleting from here down 
# if I want to turn it back.
